...
The HTML page that calls these scripts needs to call ["doms"](src/doms.js), ["fields"](src/fields.js), ["schema"](src/schema.js) and ["httprequests"](src/httprequests.js), followed by either "manager" or "annotator":
